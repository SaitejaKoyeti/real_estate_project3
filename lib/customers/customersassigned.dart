...
class CustomersAssignedScreen extends StatefulWidget {
  final String employeeId;

  CustomersAssignedScreen({required this.employeeId});

  @override
  _CustomersAssignedScreenState createState() =>
      _CustomersAssignedScreenState();
}

class _CustomersAssignedScreenState extends State<CustomersAssignedScreen> {
